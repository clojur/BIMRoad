...
CMovePick::CMovePick(osg::ref_ptr<osgText::Text> updatetext, osg::ref_ptr<osg::Group> model)
{
...
osg::ref_ptr<osg::Geode> CMovePick::CreateShape(osg::Vec3& ct, const char* str)
{
...
osg::ref_ptr<osg::Geode> CMovePick::CreateLine(osg::Vec3& begin, osg::Vec3& end)
{
	osg::ref_ptr<osg::Geode>geode = new osg::Geode;
...
osg::ref_ptr<osg::Geode> CMovePick::CreatePixel(osg::Vec3& point, const char* str)
{
	osg::ref_ptr<osg::Geode> geode = new osg::Geode;
	osg::ref_ptr<osg::Geometry> gm = new osg::Geometry;
	osg::ref_ptr<osg::Vec3Array> vertices = new osg::Vec3Array;
...
bool CMovePick::setLable(const std::string &updatetext)
{
	if (m_updateText.get())
	{
		osg::ref_ptr<osgText::Font> font = osgText::readFontFile("fonts/simsun.ttc");//读取中文字体
...
bool CMovePick::RemoveNodeByName(const char* str)
{
...
bool CMovePick::handle(const osgGA::GUIEventAdapter&ea, osgGA::GUIActionAdapter& aa)
{
